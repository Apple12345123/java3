...
public class Map1 {
    // Key와 Value의 값으로 구성되는 Map.Entry 객체를 저장하는 구조
    // Entry : Map 인터페이스 내부에 선언된 중첩 인터페이스
    // Key는 중복 저장될 수 없으며, Value는 중복 저장될 수 있음.
    ...
    *HashMap*, Hashtable, LinkedHashMap, Properties, TreeMap
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Integer> entry : map.entrySet()) {
            ...
            System.out.println(entry);  // 사과=150 toString() 되어있음
        }

        // 4. 반복자를 통한 순회]
        // map.iterator()    // Map에서는 반복자 사용 불가
        // Iterator<Map.Entry<String, Integer>> iterator = map.entrySet().iterator();  //  밑의 문장과 같은 것
        System.out.println("======================================");
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("nextEntry.getValue() = " + nextEntry.getValue());  // but 사과 출력됨.
        }
