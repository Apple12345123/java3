...
public class Ex1 {
    public static void main(String[] args) {
        ...
        System.out.println("원본 물품 리스트 = " + tripList);

        Collections.sort(tripList);
        System.out.println("정렬 후 물품 리스트 = " + tripList);

        Collections.reverse(tripList);
        System.out.println("뒤집은 후 물품 리스트 = " + tripList);

        Collections.shuffle(tripList);
        System.out.println("셔플 후 물품 리스트 = " + tripList);

        int frequency = Collections.frequency(tripList, "여권");
        System.out.println("'여권'의 빈도 수 = " + frequency);

        Collections.frequency(tripList, "책");
        System.out.println("책의 빈도수 = " + frequency);

        Collections.addAll(tripList, "휴대폰", "카메라", "책");
        System.out.println("추가물품 후 리스트 = " + tripList);

        Set<String> uniqueItems = new HashSet<>(tripList);
        System.out.println("중복제거 = " + uniqueItems);
