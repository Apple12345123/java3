...
public class Set1 {
    ...
    public static void main(String[] args) {
        ...
        boolean addDuplicate = numberSet.add(2);// 중복이 허용되지 않음
        System.out.println("addDuplicate = " + addDuplicate);

        boolean addNewElement = numberSet.add(5);// 새로운 것(중복이 아닌 요소)은 추가됨.
        ...
        // 향상된 for문 사용하여 요소 순회 => 순서를 보장할 수 없음.
        ...
        boolean removeNone = numberSet.remove(6);
