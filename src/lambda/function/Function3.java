...
public class Function3 {
    public static void main(String[] args) {
        ...
        // Function : 입력 -> 반환값
        Function<String, Integer> stringLenthFunction = string -> string.length();
        Integer i = stringLenthFunction.apply("이 문자열의 길이를 반환");
        ...
        // UnaryOperator(우항) 입력 타입과 결과 타입이 모두 같을 때
        ...
        // Counsumer 타입(함수형 인터페이스 = 함수)을 매개변수로 받음
