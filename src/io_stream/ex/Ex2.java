...
public class Ex2 {
    public static void main(String[] args) {
        // 경로
        String filePath = "scr/io_stream/ex/server.log";
        String resultPath = "scr/io_stream/ex/errorLogs.txt";
        ...
        while (true) {
            ...
            if (line.contains("ERROR")) {
                ...
                // 결과 저장: 찾은 에러 로그를 "errorLog.txt"파일에 저장합니다. 각 -에러 로그는 파일의 새로운 줄에 기록되어야 합니다.
                bw.write(line);   // 라인을 출력스트림을 통해 파일에 쓰기
                bw.newLine();   // 한 줄 개행문자 추가
                errorCount ++;      // 에러가 발생할 때마다 횟수 추가
            }
        }
        } catch (IOException e) {
