    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            switch (problemlocation) {
                case 1: // 앞 왼쪽 타이어가 펑크났을 때 HankookTire로 교체
                    System.out.println("앞 왼쪽 타이어를 HankookTire로 교체");
                    car.frontLeft = new HankookTire("앞 왼쪽", 15);
                    break;
                case 2: // 앞 왼쪽 타이어가 펑크났을 때 KumhoTire로 교체
                    System.out.println("앞 왼쪽 타이어를 KumhoTire로 교체");
                    car.frontRight = new KumhoTire("앞 오른쪽", 13);
                    break;
                case 3: // 앞 왼쪽 타이어가 펑크났을 때 HankookTire로 교체
                    System.out.println("뒤 왼쪽 타이어를 HankookTire로 교체");
                    car.backLeft = new HankookTire("뒤 왼쪽", 14);
                    break;
                case 4: // 앞 왼쪽 타이어가 펑크났을 때 KumhoTire로 교체
                    System.out.println("앞 왼쪽 타이어를 KumhoTire로 교체");
