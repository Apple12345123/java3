...
public class RandomClass {
    public static void main(String[] args) {
        ...
        // 시드 값 : 난수 생성의 시작점을 제공하고, 동일한 시드값으로 생성된 Random 객체는
        // 동일한 난수를 생성
        ...
        System.out.println("==== 시드456 ====");
        Random random456 = new Random(456);
        System.out.println(random456.nextInt(100));

        // 시드값을 설정하는 이유
        // 1. 재현성을 확보하여 디버깅, 테스트를 수행할 때, 동일한 난수 생성으로 용이하게 사용
        // 2. 예측 가능성 : 시뮬레이션 실험 등에서 동일 입력 동일 결과를 얻고자할 때 유용
        ...
        // Random 클래스를 사용하는 예시 : 개임 개발, 시뮬레이션, 보안, 암호화 등에 사용.
