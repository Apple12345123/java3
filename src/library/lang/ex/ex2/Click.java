...
public class Click {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(click1.equals(click5));
        System.out.println(click1.equals(click6));
        System.out.println(click1.equals(click7));
        System.out.println(click1.equals(click8));
    }

    /*
    LinearSerch : 위에서부터 순서대로 쫙 O(n)
    BinearySearch : 정렬되있는 경우, 절반씩 탐색범위 줄임 O(logn)
    hash : 잘게 으깬 것. hashcode
     */
