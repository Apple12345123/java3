...
public class HashCode {
    public void main(String[] args) {
        ...
        // hashCode는 hash충돌이 발생할 수 있다. : 서로 다른 입력 값에 대해서 동일한 해시값이 생성되는 경우,
        // 잘 만든 해시 함수는 hash충돌을 최소화하지만 완전히 hash 충돌이 없을 수는 없다.
    ...
    class Member {
        ...
        // equals 메서드와 일관성을 가져야함.
        // 두 메서드 모두 age와 name을 기준으로 오버라이딩
        @Override
        public boolean equals(Object o) {       // equals 누르면 뜨는 것 (???)
